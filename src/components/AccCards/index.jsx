...
export default function AccCards() {
    ...
    const { amount, setAmount,
        ...
        category, setCategory, addCash, addSpend, receitasCollectionRef, despesasCollectionRef } = useAddCash();
                        ...
                        <div className="buttons-acc">
                            ...
                            >
                                <div className="acc-text-modal" >
                                    <h2 ref={(_subtitle) => (subtitle = _subtitle)}>Adicionar dinheiro a sua conta</h2>
                                ...
                                <form>
                                    <div className="forms">
                                        <div>
                                            <input type="number" placeholder="Valor" onChange={(event) => {
                                                setAmount(event.target.value);
                                            }} />
                                            <input type="date" placeholder="Data" onChange={(event) => {
                                                setReceiptDate(event.target.value);
                                            }} />
                                            <input type="text" placeholder="Descrição" onChange={(event) => {
                                                setDescription(event.target.value);
                                            }} />
                                            <input type="text" placeholder="Categoria" list="receita" onChange={(event) => {
                                        ...
                                        <div className="btn-modal" >
                                            ...
                                            <button type="submit" onClick={addCash}>Salvar</button>
                                        </div>
                                    </div>
                            ...
                            >
                                <div className="acc-text-modal" >
                                    <h2 ref={(_subtitle) => (subtitle = _subtitle)}>Adicionar uma despesa</h2>
                                    <p>Você está no mes de {currentMonth} </p>
                                ...
                                <form>
                                    <div className="forms">
                                        <div>
                                            ...
                                            <input type="text" placeholder="Categoria" list="despesas" onChange={(event) => {
                                                setCategory(event.target.value);
                                            }} />
                                        ...
                                        <div className="btn-modal" >
                                            ...
                                            <button type="submit" onClick={addSpend}>Salvar</button>
                                        </div>
                                    </div>
                                </form>
                            </Modal>
                            ...
                            <button onClick={openModalCash}><BsFillArrowUpCircleFill /><p>Adicionar Receita</p></button>
                            <button onClick={openModalSpend} ><BsFillArrowDownCircleFill />Adicionar Despesa</button>
                        </div>
